...
public:
    ...
    //
    set<E> unmodifiableEdgeSet = 0;
    set<V> unmodifiableVertexSet = 0;
    G base;
    ...
    void addEdgesUsingFilter(set<E> edgeSet, set<E> filter)
    {
        E e;
        ...
        for (Iterator<E> iter = edgeSet.iterator(); iter.hasNext();) {
            ...
            edgeIncluded = (filter == 0) || filter.contains(e);
    ...
    private:
        ...
        void addVerticesUsingFilter(set<V> vertexSet, set<V> filter)
        {
            V v;
